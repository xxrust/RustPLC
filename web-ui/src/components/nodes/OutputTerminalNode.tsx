...
const OutputTerminalNode: React.FC<NodeProps> = ({ data, selected }) => {
    ...
    >
      ...
      <div style={{ padding: '8px 12px' }}>
        <svg width="56" height="32" viewBox="0 0 56 32">
          {/* Input line */}
          {isActive && <line x1="0" y1="16" x2="4" y2="16" stroke={color} strokeWidth="2" />}
          {/* Terminal block */}
...
export default OutputTerminalNode;
