...
class PlcGenTargetConfigTests(unittest.TestCase):
    ...
    def test_plc_gen_public_artifacts_capture_key_contracts(self) -> None:
        ...
        self.assertIn("field inputs", validation_order)
        self.assertIn("cycle start / cycle complete", validation_order)
        ...
        self.assertIn("welding_station", source_shape)
        self.assertIn("dual_axis_platform", source_shape)
        self.assertIn("complex delivery", source_shape)
        self.assertIn("main.plc", source_shape)
