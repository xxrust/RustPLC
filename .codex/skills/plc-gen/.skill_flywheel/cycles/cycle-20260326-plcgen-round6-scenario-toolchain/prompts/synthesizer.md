...
实例索引：`E:\personal_project\rust_plc\.codex\skills\plc-gen\.skill_flywheel\cycles\cycle-20260326-plcgen-round6-scenario-toolchain\logs\run-index.json`
聚合输出 Markdown：`E:\personal_project\rust_plc\.codex\skills\plc-gen\.skill_flywheel\cycles\cycle-20260326-plcgen-round6-scenario-toolchain\logs\synthesis.md`
聚合输出 JSON：`E:\personal_project\rust_plc\.codex\skills\plc-gen\.skill_flywheel\cycles\cycle-20260326-plcgen-round6-scenario-toolchain\logs\synthesis.json`
...
把聚合结果写入：`E:\personal_project\rust_plc\.codex\skills\plc-gen\.skill_flywheel\cycles\cycle-20260326-plcgen-round6-scenario-toolchain\logs\synthesis.md`。
把机器可读聚合结果写入：`E:\personal_project\rust_plc\.codex\skills\plc-gen\.skill_flywheel\cycles\cycle-20260326-plcgen-round6-scenario-toolchain\logs\synthesis.json`。
