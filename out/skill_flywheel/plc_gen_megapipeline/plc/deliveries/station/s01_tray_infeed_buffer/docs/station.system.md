...
- Workpiece context: `tray_module_pack`

## Workpiece semantics
- `workpiece tray_module_pack: workpiece_type`
...
## Flow outline
1. The operator or upstream buffer loads an empty tray at `tray_pickup`; `acquire tray_bay tray_module_pack from tray_pickup`.
