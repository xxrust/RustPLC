...
- Workpiece: `aligned_module_stack`

## Workpiece semantics
- `workpiece aligned_module_stack: workpiece_type`
...
## Flow
1. Receives `tray_module_pack` at `alignment_ready` and runs `effect: acquire alignment_table aligned_module_stack from alignment_ready`.
