use crate::ast::{
    ...
    ControllerIoAliasDeclaration, ControllerIoDeclaration, ControllerIoDirection, DeviceAttributes,
    DeviceDeclaration, DevicePort, DeviceTags, DeviceType, DurationValue, EffectKind,
