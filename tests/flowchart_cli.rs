...
"#,
    ...
    assert!(html.contains("flow-svg"));
    assert!(html.contains("sfc-review"));
    assert!(html.contains("task-sfc-svg"));
    assert!(html.contains("task-step"));
    assert!(html.contains("task-transition-bar"));
    assert!(html.contains("task-transition-target"));
    assert!(!html.contains("sfc-segment"));
